...
document.getElementById('add-classes-button').addEventListener('click', addClasses, false);


function addClasses(){
        //open a port and recieve a message with subject and course number, similar to below format
        subject = "AMH";
        course = '"AMH|2010"';
